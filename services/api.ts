...
export const api = {
  ...
  // --- 接口 2: 新增多维表格 ---
  createTable: (payload: { name: string; columns?: Partial<Column>[]; views?: Partial<ViewMetadata>[] }): Promise<ApiResponse<Table>> => 
  ...
  // --- 接口 3: 修改表格名称 ---
  updateTable: (tableId: string, payload: { name: string }): Promise<ApiResponse<{id: string, name: string}>> => 
