...
import { ICONS, FIELD_TYPE_ICONS, formatFieldValue, getTagColor, formatDateForInput, formatDateForDisplay, parseJsonArray, parseLinkValues } from '../constants';
...
const LinkedRecordsTable = ({ 
    ...
    const renderCell = (row: Row, col: Column) => {
        ...
        switch (col.type) {
            ...
            case FieldType.DATE:
                return <span className="text-gray-600 text-[10px]">{formatDateForDisplay(val)}</span>;
